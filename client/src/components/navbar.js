...
export default function Navbar() {
 ...
 return (
        <div className="image" style={{"display":"flex","justifyContent":"space-between", "padding":"10px","backgroundColor":"rgb(224, 223, 222)","borderStyle":"solid","position":"fixed","width":"100%","top":"0"}}>
